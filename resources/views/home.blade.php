...
@section('content')
    ...
    <main>
        ...
        <div class="w-11/12 max-w-3xl text-center mx-auto pt-40 pb-20 flex flex-col items-center gap-6">
            <img src="{{ asset('images/Astrantia Logo.jpg') }}" alt="Profile" class="rounded-full w-32 shadow-lg border-4 border-white" />
            ...
            <h4 class="text-2xl font-Ovo font-semibold text-gray-800 mt-10">
                Akses Cepat
            </h4>
            ...
            <div class="flex flex-col sm:flex-row items-center gap-4 mt-4">
                <a href="{{ route('member') }}" class="px-10 py-2.5 border rounded-full bg-[#2a1b45] text-white flex items-center gap-2">
                    Anggota <img src="{{ asset('images/right-arrow-white.png') }}" alt="" class="w-4">
                </a>
                <a href="{{ route('schedules') }}" class="px-10 py-2.5 border rounded-full bg-[#2a1b45] text-white flex items-center gap-2">
                    Jadwal <img src="{{ asset('images/right-arrow-white.png') }}" alt="" class="w-4">
                </a>
                <a href="{{ route('materials') }}" class="px-10 py-2.5 border rounded-full bg-[#2a1b45] text-white flex items-center gap-2">
                    Materi <img src="{{ asset('images/right-arrow-white.png') }}" alt="" class="w-4">
                </a>
                <a href="{{ route('assignments') }}" class="px-10 py-2.5 border rounded-full bg-[#2a1b45] text-white flex items-center gap-2">
                    Tugas <img src="{{ asset('images/right-arrow-white.png') }}" alt="" class="w-4">
                </a>
                <a href="{{ route('galleries') }}" class="px-10 py-2.5 border rounded-full bg-[#2a1b45] text-white flex items-center gap-2">
            ...
            <div class="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
                ...
                <div class="flex-1">
                    ...
                    <ul class="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl">
                        <li class="border border-gray-300 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black">
                            <h3 class="font-semibold text-gray-700">Angkatan</h3>
                            <p class="text-gray-600 text-sm">2023</p>
                        </li>
                        <li class="border border-gray-300 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black">
                            <h3 class="font-semibold text-gray-700">Kelas</h3>
                            <p class="text-gray-600 text-sm">Sistem Informasi A</p>
                        </li>
                        <li class="border border-gray-300 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black">
                            <h3 class="font-semibold text-gray-700">Program Studi</h3>
                            <p class="text-gray-600 text-sm">S1 Sistem Informasi</p>
                        </li>
                        <li class="border border-gray-300 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black">
                            <h3 class="font-semibold text-gray-700">Jurusan</h3>
                            <p class="text-gray-600 text-sm">Teknologi Informasi</p>
                        </li>
                        <li class="border border-gray-300 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black">
                            <h3 class="font-semibold text-gray-700">Fakultas</h3>
                            <p class="text-gray-600 text-sm">Fakultas Teknik</p>
                        </li>
                        <li class="border border-gray-300 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black">
                            <h3 class="font-semibold text-gray-700">Universitas</h3>
                            <p class="text-gray-600 text-sm">Universitas Tadulako</p>
                        </li>
                    </ul>
                    <ul class="flex items-center gap-3 sm:gap-5 mt-10">
                        <li class="flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-300 rounded-lg cursor-pointer hover:-translate-y-1 duration-500">
        ...
        <div>
            ...
            <section id="jadwal" class="flex flex-col items-center justify-center py-10 px-4">
                <h4 class="text-2xl font-Ovo font-semibold text-gray-800 mt-4 mb-2 text-center">
                ...
                @if($schedules->isEmpty())
                    <div class="flex flex-col items-center justify-center text-center py-10 animate-fade-in my-6">
                        ...
                        <p class="text-gray-500 mt-2">Silakan istirahat atau kerjakan tugas!</p>
                    </div>
                @else
                    <div class='flex flex-wrap justify-center gap-6 w-full max-w-8xl'>
                        @foreach($schedules as $schedule)
                            <div class='group relative bg-white w-full md:w-[380px] rounded-2xl shadow-lg border border-gray-100 overflow-hidden transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl'>
                                <div class="h-2 w-full bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500"></div>
                                <div class="p-7">
                                    <div class="flex justify-between items-start mb-4">
                                        <span class="px-3 py-1 rounded-full text-xs font-bold tracking-wide uppercase bg-purple-100 text-purple-700">
                                    ...
                                    <h3 class="text-2xl font-bold text-gray-800 mb-2 leading-tight group-hover:text-purple-600 transition-colors">
                                        {{ $schedule->subject }}
                                    </h3>
                                    <div class="flex items-center gap-2 mb-6">
                                        ...
                                        <span class="text-base text-gray-600 font-medium">Ruang {{ $schedule->room }}</span>
                                    </div>
                                        ...
                                        <div class="space-y-3">
                                            @foreach($schedule->lecturers as $lecturer)
                                                <div class="flex items-center gap-3">
                                                    <div class="w-9 h-9 shrink-0 rounded-full bg-indigo-100 border border-indigo-200 flex items-center justify-center text-xs font-bold text-indigo-700 shadow-sm">
            ...
            <section class="flex flex-col md:flex-row items-center justify-center md:items-start gap-8 max-md:px-4 w-full max-w-4xl mx-auto">
                <div id="tugas" class="w-full mt-20"> 
                    <h4 class="text-2xl font-Ovo font-semibold text-gray-800 text-center mb-10">
                        Tugas & Deadline
                    </h4>
                    <div class="flex flex-col items-center gap-4 w-full max-w-4xl mx-auto">
                        @if($assignments->isEmpty())
                            <div class="flex flex-col items-center justify-center text-center py-16 animate-fade-in w-full">
                                <div class="bg-green-50 p-6 rounded-full mb-6 ring-1 ring-green-100">
                                ...
                                <h3 class="text-xl font-bold text-gray-800">Hore! Tidak Ada Tugas</h3>
                        ...
                        @else
                            @foreach($assignments as $task)
                                <div class="w-full border border-gray-200 bg-white rounded-2xl shadow-sm hover:shadow-md transition duration-300 overflow-hidden">
                                    <button onclick="toggleTask({{ $task->id }})" class="w-full text-left p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 focus:outline-none group">
                                        <div class="flex-1 w-full">
                                            ...
                                            <div class="text-indigo-600 font-medium text-sm mb-3">
                                                {{ $task->course }}
                                            </div>
                                            <div class="flex items-center gap-2 text-xs font-medium text-red-500 bg-red-50 w-fit px-3 py-1.5 rounded-lg border border-red-100">
                                        ...
                                        <div class="flex items-center gap-4 w-full md:w-auto justify-between md:justify-end mt-2 md:mt-0 pl-0 md:pl-4 md:border-l border-gray-100">
                                            <div class="text-left md:text-right">
                                                <p class="text-[10px] text-gray-400 uppercase font-semibold tracking-wider mb-0.5">Tenggat</p>
                                                <div class="flex items-center gap-1.5 text-xs text-gray-600 font-medium whitespace-nowrap">
                                                    {{ \Carbon\Carbon::parse($task->deadline)->translatedFormat('d F, H:i') }} WIB
                                                </div>
                                            </div>
                                            <div class="bg-gray-50 p-2 rounded-full group-hover:bg-indigo-50 transition-colors">
                                    ...
                                    <div id="content-{{ $task->id }}" class="hidden px-6 pb-6 border-t border-gray-100 bg-gray-50/30">
                                        <div class="mt-4 text-gray-600 text-sm prose max-w-none">
