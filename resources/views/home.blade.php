...
@section('content')
    ...
    <main>
        ...
        <div class="w-11/12 max-w-3xl text-center mx-auto pt-40 pb-20 flex flex-col items-center gap-6">
            <img src="{{ asset('images/Astrantia Logo.jpg') }}" alt="Profile" class="rounded-full w-32 shadow-lg border-4 border-white border-gray-700" />
            
            <h1 class="text-2xl sm:text-4xl lg:text-[40px] leading-tight font-Ovo font-bold text-gray-800 text-white">
                Astrantia
            </h1>
            <h3 class="flex items-end gap-2 text-xl md:text-2xl font-Ovo font-medium text-gray-900 text-white">
                wherever we stand; we are one; since we were born.
            </h3>
            
            <div class="flex flex-col gap-6 text-gray-600 text-gray-300">
            ...
            <div class="flex flex-col sm:flex-row items-center gap-4 mt-4">
                <a href="https://www.instagram.com/si.astrantia/" target="_blank"
                    class="px-10 py-2.5 border rounded-full bg-gradient-to-r from-[#b820e6] to-[#da7d20] text-white flex items-center gap-2 border-transparent">
            ...
            <h4 class="text-2xl font-Ovo font-semibold text-gray-800 text-white mt-10">
                Akses Cepat
            </h4>
            <p class="text-gray-600 text-gray-300 text-sm">
                Menu utama untuk mengakses informasi kelas Astrantia
            </p>
            <div class="flex flex-col sm:flex-row items-center gap-4 mt-4">
                <a href="{{ route('member') }}" class="px-10 py-2.5 border rounded-full bg-[#2a1b45] text-white flex items-center gap-2 border-transparent">
                    Anggota <img src="{{ asset('images/right-arrow-white.png') }}" alt="" class="w-4">
                </a>
                <a href="{{ route('schedules') }}" class="px-10 py-2.5 border rounded-full bg-[#2a1b45] text-white flex items-center gap-2 border-transparent">
                    Jadwal <img src="{{ asset('images/right-arrow-white.png') }}" alt="" class="w-4">
                </a>
                <a href="{{ route('materials') }}" class="px-10 py-2.5 border rounded-full bg-[#2a1b45] text-white flex items-center gap-2 border-transparent">
                    Materi <img src="{{ asset('images/right-arrow-white.png') }}" alt="" class="w-4">
                </a>
                <a href="{{ route('assignments') }}" class="px-10 py-2.5 border rounded-full bg-[#2a1b45] text-white flex items-center gap-2 border-transparent">
                    Tugas <img src="{{ asset('images/right-arrow-white.png') }}" alt="" class="w-4">
                </a>
                <a href="{{ route('galleries') }}" class="px-10 py-2.5 border rounded-full bg-[#2a1b45] text-white flex items-center gap-2 border-transparent">
            ...
            <div class="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
                ...
                <div class="flex-1">
                    ...
                    <ul class="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl">
                        <li class="border border-gray-300 border-white/30 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black hover:shadow-white/80 hover:bg-darkHover/50">
                            <h3 class="font-semibold text-gray-700 text-white">Angkatan</h3>
                            <p class="text-gray-600 text-sm text-white/80">2023</p>
                        </li>
                        <li class="border border-gray-300 border-white/30 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black hover:shadow-white/80 hover:bg-darkHover/50">
                            <h3 class="font-semibold text-gray-700 text-white">Kelas</h3>
                            <p class="text-gray-600 text-sm text-white/80">Sistem Informasi A</p>
                        </li>
                        <li class="border border-gray-300 border-white/30 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black hover:shadow-white/80 hover:bg-darkHover/50">
                            <h3 class="font-semibold text-gray-700 text-white">Program Studi</h3>
                            <p class="text-gray-600 text-sm text-white/80">S1 Sistem Informasi</p>
                        </li>
                        <li class="border border-gray-300 border-white/30 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black hover:shadow-white/80 hover:bg-darkHover/50">
                            <h3 class="font-semibold text-gray-700 text-white">Jurusan</h3>
                            <p class="text-gray-600 text-sm text-white/80">Teknologi Informasi</p>
                        </li>
                        <li class="border border-gray-300 border-white/30 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black hover:shadow-white/80 hover:bg-darkHover/50">
                            <h3 class="font-semibold text-gray-700 text-white">Fakultas</h3>
                            <p class="text-gray-600 text-sm text-white/80">Fakultas Teknik</p>
                        </li>
                        <li class="border border-gray-300 border-white/30 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black hover:shadow-white/80 hover:bg-darkHover/50">
                            <h3 class="font-semibold text-gray-700 text-white">Universitas</h3>
                            <p class="text-gray-600 text-sm text-white/80">Universitas Tadulako</p>
                        </li>
                    </ul>
                    <ul class="flex items-center gap-3 sm:gap-5 mt-10">
                        <li class="flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-300 border-white/30 rounded-lg cursor-pointer hover:-translate-y-1 duration-500">
        ...
        <div>
            ...
            <section id="jadwal" class="flex flex-col items-center justify-center py-10 px-4">
                <h4 class="text-2xl font-Ovo font-semibold text-gray-800 text-white mt-4 mb-2 text-center">
                ...
                @if($schedules->isEmpty())
                    <div class="flex flex-col items-center justify-center text-center py-10 animate-fade-in my-6">
                        <div class="bg-gray-100 bg-gray-800 p-6 rounded-full mb-4">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-12 h-12 text-gray-400">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                            </svg>
                        </div>
                        <h3 class="text-xl font-bold text-gray-800 text-white">Tidak Ada Jadwal Hari Ini</h3>
                        <p class="text-gray-500 text-gray-400 mt-2">Silakan istirahat atau kerjakan tugas!</p>
                    </div>
                @else
                    <div class='flex flex-wrap justify-center gap-6 w-full max-w-8xl'>
                        @foreach($schedules as $schedule)
                            <div class='group relative bg-white bg-gray-800 w-full md:w-[380px] rounded-2xl shadow-lg border border-gray-100 border-gray-700 overflow-hidden transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl'>
                                <div class="h-2 w-full bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500"></div>
                                <div class="p-7">
                                    <div class="flex justify-between items-start mb-4">
                                            <span class="px-3 py-1 rounded-full text-xs font-bold tracking-wide uppercase bg-purple-100 text-purple-700 bg-purple-900 text-purple-200">
                                            Kelas {{ $schedule->class }}
                                        </span>
                                        <div class="flex items-center gap-1.5 text-gray-500 text-gray-400 text-sm font-medium">
                                    ...
                                    <h3 class="text-2xl font-bold text-gray-800 text-white mb-2 leading-tight group-hover:text-purple-600 group-hover:text-purple-400 transition-colors">
                                        {{ $schedule->subject }}
                                    </h3>
                                    <div class="flex items-center gap-2 mb-6">
                                        ...
                                        <span class="text-base text-gray-600 text-gray-300 font-medium">Ruang {{ $schedule->room }}</span>
                                    </div>
                                    <div class="w-full h-px bg-gray-100 bg-gray-700 mb-5"></div>
                                    <div>
                                        ...
                                        <div class="space-y-3">
                                            @foreach($schedule->lecturers as $lecturer)
                                                <div class="flex items-center gap-3">
                                                    <div class="w-9 h-9 shrink-0 rounded-full bg-indigo-100 bg-gray-700 border border-indigo-200 border-gray-600 flex items-center justify-center text-xs font-bold text-indigo-700 text-indigo-300 shadow-sm">
                                                        {{ strtoupper(substr($lecturer, 0, 2)) }}
                                                    </div>
                                                    <span class="text-sm text-gray-700 text-gray-300 font-medium leading-tight">
                                                        {{ $lecturer }}
                                                    </span>
                                                </div>
                                            @endforeach
            ...
            <section class="flex flex-col md:flex-row items-center justify-center md:items-start gap-8 max-md:px-4 w-full max-w-4xl mx-auto">
                <div id="tugas" class="w-full mt-20"> 
                    <h4 class="text-2xl font-Ovo font-semibold text-gray-800 text-white text-center mb-10">
                        Tugas & Deadline
                    </h4>
                    <div class="flex flex-col items-center gap-4 w-full max-w-4xl mx-auto">
                        @if($assignments->isEmpty())
                            <div class="flex flex-col items-center justify-center text-center py-16 animate-fade-in w-full">
                                <div class="bg-green-50 bg-gray-800 p-6 rounded-full mb-6 ring-1 ring-green-100 ring-gray-700">
                                ...
                                <h3 class="text-xl font-bold text-gray-800 text-white">Hore! Tidak Ada Tugas</h3>
                                <p class="text-gray-500 text-gray-400 mt-2 max-w-md mx-auto">
                                    Nikmati waktu luangmu atau pelajari materi mendatang!
                                </p>
                            </div>
                        @else
                            @foreach($assignments as $task)
                                <div class="w-full border border-gray-200 border-gray-700 bg-white bg-gray-800 rounded-2xl shadow-sm hover:shadow-md transition duration-300 overflow-hidden">
                                    <button onclick="toggleTask({{ $task->id }})" class="w-full text-left p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 focus:outline-none group">
                                        <div class="flex-1 w-full">
                                            <div class="flex flex-wrap items-center gap-3 mb-1">
                                                <h3 class="text-lg font-bold text-gray-800 text-white group-hover:text-indigo-600 group-hover:text-indigo-400 transition-colors">
                                                    {{ $task->title }}
                                                </h3>
                                            ...
                                            <div class="text-indigo-600 text-indigo-400 font-medium text-sm mb-3">
                                                {{ $task->course }}
                                            </div>
                                            <div class="flex items-center gap-2 text-xs font-medium text-red-500 bg-red-50 bg-red-900/20 w-fit px-3 py-1.5 rounded-lg border border-red-100 border-red-800/30">
                                            ...
                                            <div class="flex items-center gap-4 w-full md:w-auto justify-between md:justify-end mt-2 md:mt-0 pl-0 md:pl-4 md:border-l border-gray-100 border-gray-700">
                                            <div class="text-left md:text-right">
                                                <p class="text-[10px] text-gray-400 uppercase font-semibold tracking-wider mb-0.5">Tenggat</p>
                                                <div class="flex items-center gap-1.5 text-xs text-gray-600 text-gray-300 font-medium whitespace-nowrap">
                                                    {{ \Carbon\Carbon::parse($task->deadline)->translatedFormat('d F, H:i') }} WIB
                                                </div>
                                            </div>
                                            <div class="bg-gray-50 bg-gray-700 p-2 rounded-full group-hover:bg-indigo-50 group-hover:bg-indigo-900/50 transition-colors">
                                    ...
                                    <div id="content-{{ $task->id }}" class="hidden px-6 pb-6 border-t border-gray-100 border-gray-700 bg-gray-50/30 bg-gray-800/30">
                                        <div class="mt-4 text-gray-600 text-gray-300 text-sm prose prose-invert max-w-none">
                                            ...
                                            <div class="flex flex-col sm:flex-row gap-3 mt-6 pt-4 border-t border-gray-200">
                                                @if(!empty($task->file_path) && is_array($task->file_path))
                                                    @foreach($task->file_path as $path)
                                                        <a href="{{ asset('storage/' . $path) }}" download target="_blank" class="flex items-center justify-center gap-2 px-4 py-2.5 text-xs font-bold text-indigo-700 bg-white border border-indigo-200 hover:bg-indigo-50 rounded-xl transition shadow-sm">
            ...
            <section id="anggota" class="w-full pt-28 pb-10 mt-20">
                ...
                <div class="marquee-paused marquee-row w-full mx-auto max-w-full overflow-hidden relative mb-8">
                    ...
                    <div class="absolute right-0 top-0 h-full w-20 z-10 pointer-events-none bg-gradient-to-l from-gray-50 to-transparent"></div>
                </div>
            ...
            <section id="galeri" class="w-full pt-20 pb-20">
                <h2 class="text-center text-4xl font-Ovo font-bold text-gray-800 mb-12">GALERI</h2>
    ...
    <script>
        ...
        const createCard = (card) => `
            <div class="bg-white p-6 rounded-xl mx-2 shadow-sm border border-gray-100 w-72 shrink-0 flex flex-col items-center text-center transition-transform hover:scale-105 duration-300">
                <img class="size-16 rounded-full mb-4 object-cover border-2 border-indigo-500" src="${card.image}" alt="${card.name}">
                <h3 class="font-bold text-lg text-gray-900">${card.name}</h3>
                <div class="w-8 h-1 bg-indigo-500 rounded-full my-3"></div>
                <p class="text-sm text-gray-500 italic">"${card.quote}"</p>
            </div>
        `;
