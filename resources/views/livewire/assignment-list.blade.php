<div>
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-10">
            <h2 class="text-4xl font-Ovo font-bold text-gray-800 mb-4">DAFTAR TUGAS</h2>
            <p class="text-gray-500">Pantau tenggat waktu dan kumpulkan tugas tepat waktu</p>
        </div>
        ...
        <div class="flex flex-col gap-4">
            @forelse($assignments as $task)
                <div class="w-full border border-gray-200 bg-white rounded-2xl shadow-sm hover:shadow-md transition duration-300 overflow-hidden group">
            ...
            @empty
                <div class="text-center py-20 rounded-2xl">
                    ...
                    <h3 class="text-lg font-bold text-gray-800">Tidak ada tugas ditemukan</h3>
                    <p class="text-gray-500">Coba kata kunci lain atau belum ada tugas baru.</p>
                </div>
            @endforelse
        </div>
        <div class="mt-8">
